...
<<<<<<< HEAD
select_archs = ['not_unet_efn']
IMG_PROCESSING = 'simple'
# save_folder = 'not_unet_efn_Albu'
save_folders = ['not_unet_efn_Albu']
counts = [2]
=======
...
=======
                os.system(
                    f'CUDA_VISIBLE_DEVICES=0 python main.py --dataset=Class{count} --arch={select_arch} --dip={IMG_PROCESSING} --count={test} --save_folder={save_folder} --gpu --train')
                count += 2
            # elif info_2.used <= 150:
            #     os.system(f'CUDA_VISIBLE_DEVICES=1 python main.py --dataset=Class{count} --arch={select_arch} --dip={IMG_PROCESSING} --count={test} --save_folder={save_folder} --gpu --train')
            #     count += 2
